...
class match:
	...
	def invite(self, fro, to):
		...
		# Rohwabot is too busy
		if to == 999:
			froToken.enqueue(serverPackets.sendMessage("Rohwabot", froToken.username, "I would love to join your match, but I'm busy keeping ripple up and running. Sorry. Beep Boop."))
